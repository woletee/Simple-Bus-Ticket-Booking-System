...
<body>
    ...
    <?php
        ...
        */
        ...
        // Check if 'bustype' key is present in $_POST array
        if (isset($_POST["bustype"])) {
            $bustype = $_POST["bustype"];
        } else {
            // Handle the case when 'bustype' is not provided
            // You can set a default value or show an error message
            // For example:
            $bustype = ""; // Set a default value
            // Or show an error message and return or redirect
        ...
        if (!$bus_exists) {
            $sql = "INSERT INTO `buses` (`bus_no`, `bus_type`, `bus_created`) VALUES ('$busno', '$bustype', current_timestamp());";
